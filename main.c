...
#define ON_Board_LED                                                           
//--> Defining an On Board LED, used for indicators when the process of
    //connecting to a wifi router

//----------------------------------------SSID and Password of your WiFi router.
const char *ssid = "GITAM-5GHz";     //--> Your wifi name or SSID.
const char *password = "Gitam$$123"; //--> Your wifi password.
//----------------------------------------
...
String GAS_ID = "AKfycbz5wuhVs-R8l-Veg4yVXrkOp2AKl9VRkwZVy1KKzwK9"; //--> spreadsheet script
                                                        //ID
...
void setup() {
  ...
  //----------------------------------------If successfully connected to the
  //wifi router, the IP Address that will be visited is displayed in the serial
  //monitor
  Serial.println("");
...
void loop() {
  ...
  String Ecg = "value1 : " + String(myecg);
  Serial.println(Ecg);
...
void sendData(float myecg) {
  ...
  String url = "/macros/s/" + GAS_ID + "/exec?value1=" + string_ecg;//remember to add script.google.com if doesnt work
